package com.capgemini.tag.aop;

import com.capgemini.common.util.JWTUtil;
import com.capgemini.tag.annotation.MyRequireRole;
import com.capgemini.tag.feign.LoginFeign;
...
public class MyRequireRoleAop {
    ...
    @Pointcut("@annotation(com.capgemini.tag.annotation.MyRequireRole)")
