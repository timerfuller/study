package com.capgemini.zuul.interceptor;

import com.google.gson.Gson;
import com.capgemini.common.bean.ErrorEnum;
import com.capgemini.common.util.JWTUtil;
import com.capgemini.zuul.service.RedisService;
...
public class SsoInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest servletRequest, HttpServletResponse servletResponse, Object handler) throws Exception {
        ...
        printWriter.write(new Gson().toJson(new com.capgemini.common.bean.ResponseBean(ErrorEnum.ERROR_10002.getErrorCode(),ErrorEnum.ERROR_10002.getErrorMsg(),"")));
        printWriter.flush();
